...
<div class="row-fluid">
    <div class="control-group">
        <div class="controls">
            <button type="submit" class="btn btn-info"><i class="icon-share"></i> Marcar como enviada(s)</button>
        </div>
    </div>
    <div class="control-group">
        <div class="controls">
...
$(document).ready(function(){
    ...
    $('#form_tabla').validate({
        ...
        submitHandler: function(form){
            if(confirm("¿Marcar como enviadas la orden(es) de compra?")){
                form.submit();
            }
        }
    });
    
    var url = "<?php echo site_url(); ?>/compras/ordenes_compra/ordenes_compra_enviar";
