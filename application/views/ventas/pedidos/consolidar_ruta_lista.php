...
<div class="row-fluid">
    ...
    <div class="control-group">
        <label for="fecha_programada" class="control-label">Fecha de envío: </label>
        <div class="controls">
    ...
    <div class="control-group">
        <div class="controls">
            <button type="submit" class="btn btn-info">Procesar pedido(s)</button>
        </div>
    </div>
    <div class="control-group">
        <div class="controls">
